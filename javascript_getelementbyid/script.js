...
function allOpaque(el){
	document.getElementById("face").classList.add("opaque");
	document.getElementById("noface").classList.add("opaque");	
	document.getElementById("prayer").classList.add("opaque");
}
